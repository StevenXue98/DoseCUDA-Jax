...
NRRD files under test_phantom_output.  CUDA remains an exact historical check.
The legacy JAX golden is a bounded drift check because it was generated by the
prototype whose axis and CUDA-compatibility bugs this port now corrects.
"""
...
def main():
    ...
    if jax_history["max_pct"] > 0.1 or jax_history["correlation"] < 0.999999:
        raise SystemExit("JAX result has drifted too far from the historical JAX reference")
